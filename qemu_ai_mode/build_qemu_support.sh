...
patch -p0 <patches/tcg-runtime.c.diff || exit 1
patch -p0 <patches/translate.c.diff || exit 1
patch -p0 <patches/tcg.h.diff || exit 1
patch -p0 <patches/int_helper.c.diff || exit 1
patch -p0 <patches/tcg-runtime.h.diff || exit 1
patch -p0 <patches/tcg-op.c.diff || exit 1
